...
// Layers
#define LTG_KBA TG(KBAR_BSE)
#define LMO_PRI LT(KBAR_PRI, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
		...
		_______, _______, _______, KC_CALC, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, LTG_KBA,          _______,  RGB_VAI, _______,
    ...
    [KBAR_BSE] = LAYOUT( /* Base */
		KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_DEL,           KC_MUTE,
		KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSPC,          KC_HOME,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,  KC_BSLS,          KC_PGUP,
		KC_BSPC, MLG_A,   MLA_S,   MLC_D,   MLS_F,   KC_G,    KC_H,    MRG_J,   MRA_K,   MRC_L,   MRS_C,   KC_QUOT, KC_NUHS,  KC_ENT,           KC_PGDN,
		KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,           KC_RSFT, KC_UP,   KC_END,
		KC_LCTL, KC_LGUI, KC_LALT,                   LMO_PRI,                            KC_RALT, MO(WIN_FN2),KC_RCTL,         KC_LEFT, KC_DOWN, KC_RGHT),
	
    [KBAR_PRI] = LAYOUT( /* Base */
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
	...
	[KBAR_BSE] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) }, 
	[KBAR_PRI] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) }, 
    [WIN_FN2] = { ENCODER_CCW_CW(RGB_VAI, RGB_VAD) },
};
#endif
