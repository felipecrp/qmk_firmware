...
[KBAR_SY2] = LAYOUT_split_3x6_3(
    ...
    _______,  KC_AMPR,  KC_RABK,  KC_LABK,  KC_LPRN,  KC_RPRN,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  KC_BSLS,  KC_RBRC,  KC_LBRC,  KC_LCBR,  KC_RCBR,  _______,  _______,  _______,  _______,  _______,  _______,
