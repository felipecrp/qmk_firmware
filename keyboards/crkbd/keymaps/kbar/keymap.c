...
[KBAR_MSE] = LAYOUT_split_3x6_3(
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_ACL2,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  KC_ACL1,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  KC_WH_L,  KC_WH_D,  KC_WH_U,  KC_WH_R,  KC_ACL0,  _______,
...
[KBAR_SYM] = LAYOUT_split_3x6_3(
    ...
    _______,  _______,  KC_GRV,   KC_CEDIL, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
                                  _______,  _______,  _______,  _______,  _______,  _______   
),

[KBAR_SY2] = LAYOUT_split_3x6_3(
    _______,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_AMPR,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  KC_PERC,  KC_RCBR,  KC_LCBR,  KC_LPRN,  KC_RPRN,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  KC_BSLS,  KC_RBRC,  KC_LBRC,  KC_LABK,  KC_RABK,  _______,  _______,  _______,  _______,  _______,  _______,
...
[KBAR_FUN] = LAYOUT_split_3x6_3(
    ...
    _______,  KC_F11,   KC_F12,   _______,  CW_TOGG,  KC_CAPS,  _______,  _______,  _______,  _______,  _______,  _______,
                                  _______,  _______,  _______,  _______,  _______,  _______   
),
