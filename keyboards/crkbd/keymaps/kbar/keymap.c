...
const key_override_t delete_key_override = ko_make_basic(MOD_MASK_SHIFT, MT_BSPC, KC_DEL);
...
[KBAR_MSE] = LAYOUT_split_3x6_3(
    _______,  _______,  _______,  _______,  _______,  QK_BOOT,  _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_ACL2,  _______,
