...
[KBAR_GAM] = LAYOUT_planck_mit(
    KC_CAPS,    KC_Q,     KC_W,     KC_E,     KC_R,     _______,  _______,  KC_T,     KC_Y,  _______,  _______,  _______,
    KC_LSFT,    KC_A,     KC_S,     KC_D,     KC_F,     _______,  _______,  KC_G,     KC_H,  _______,  _______,  _______,
    KC_LCTL,    KC_Z,     KC_X,     KC_C,     KC_V,     _______,  _______,  KC_B,     KC_N,  _______,  _______,  _______,
    _______, _______,     KC_LSFT,   KC_LCTL,  MO_GA2,  _______,            _______,  _______,  _______,  _______,  _______   
),

[KBAR_GA2] = LAYOUT_planck_mit(
    KC_1,     KC_2,     _______,  KC_3,     KC_4,     _______,  _______,  _______,  _______,  _______,  _______,  _______,
    KC_5,     _______,  _______,  _______,  KC_6,     _______,  _______,  _______,  _______,  _______,  _______,  _______,
    KC_TAB,   KC_8,     KC_9,     KC_B,     KC_ESC,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  _______,  _______   
),
