...
[KBAR_SYM] = LAYOUT_planck_mit(
    ...
    _______,  _______,  KC_COLN,  KC_MINS,  KC_UNDS,  _______,            _______,  _______,  _______,  _______,  _______   
),

[KBAR_SY2] = LAYOUT_planck_mit(
    _______,  KC_CIRC,  _______,  KC_LPRN,  KC_RPRN,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
...
[KBAR_FUN] = LAYOUT_planck_mit(
    ...
    KC_F11,   KC_F12,   _______,  CW_TOGG,  KC_CAPS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
...
[KBAR_GAM] = LAYOUT_planck_mit(
    KC_1,    KC_Q,     KC_W,     KC_E,     KC_R,     _______,  _______,  KC_T,     _______,  _______,  _______,  _______,
    KC_2,    KC_A,     KC_S,     KC_D,     KC_F,     _______,  _______,  KC_G,     _______,  _______,  _______,  _______,
    KC_3,    KC_Z,     KC_X,     KC_C,     KC_V,     _______,  _______,  KC_B,     _______,  _______,  _______,  _______,
    _______, _______,  MO_GA2,   KC_LCTL,  KC_LSFT,  _______,            _______,  _______,  _______,  _______,  _______   
),

[KBAR_GA2] = LAYOUT_planck_mit(
    KC_4,     KC_7,     _______,  KC_0,     KC_T,     _______,  _______,  _______,  _______,  _______,  _______,  _______,
    KC_CAPS,  _______,  _______,  _______,  KC_G,     _______,  _______,  _______,  _______,  _______,  _______,  _______,
    KC_6,     KC_8,     KC_9,     KC_B,     KC_ESC,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  _______,  _______   
),
